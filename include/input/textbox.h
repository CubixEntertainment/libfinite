...
#define finite_input_textbox_set_callbacks(textbox, on_focused, on_commit, on_done) finite_input_textbox_set_callbacks_debug(__FILE__, __func__, __LINE__, textbox, on_focused, on_commit, on_done)
