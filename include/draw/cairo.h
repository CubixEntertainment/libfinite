...
#define finite_draw_glow(shell, x, y, width, height, radius, layers, color, withPreserve) finite_draw_glow_debug(__FILE__, __func__, __LINE__, shell, x, y, width, height, radius, layers, color, withPreserve)
...
#define finite_draw_set_offset(shell, x, y) finite_draw_set_offset_debug(__FILE__, __func__, __LINE__, shell, x, y)
void finite_draw_set_offset_debug(const char *file, const char *func, int line, FiniteShell *shell, double x, double y);

#define finite_draw_reset_offset(shell, x, y) finite_draw_reset_offset_debug(__FILE__, __func__, __LINE__, shell, x, y)
...
#define finite_draw_set_pattern_dithering(pattern, mode) finite_draw_set_pattern_dithering_debug(__FILE__, __func__, __LINE__, pattern, mode)
