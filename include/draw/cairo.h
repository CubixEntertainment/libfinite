...
cairo_pattern_t *finite_draw_pattern_radial(double startX, double startY, double endX, double endY, FiniteGradientPoint *points, double startRadius, double endRadius);
